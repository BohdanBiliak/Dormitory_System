...
export function NewPasswordForm() {
  ...
  if (isSuccess) {
    return (
      <NewPasswordTutorial>
        <div className="w-full max-w-md mx-auto my-auto px-4 sm:px-6 lg:px-8 password-success-status">
          <div className="text-center">
            <div className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6 password-success-icon">
  ...
  return (
    <NewPasswordTutorial>
      <div className="w-full max-w-md mx-auto my-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-6 sm:mb-8 new-password-header">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
          <div className="bg-gray-50 p-4 sm:p-6 rounded-lg border password-input-section">
          ...
          <div className="space-y-3 sm:space-y-4">
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-blue-900 text-white py-2.5 sm:py-3 lg:py-4 px-4 sm:px-6 rounded-md hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2  disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2 text-sm sm:text-base font-medium shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 disabled:transform-none update-password-button"
            >
              {isLoading && (
