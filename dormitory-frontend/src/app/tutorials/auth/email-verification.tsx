...
const emailVerificationSteps: TutorialStep[] = [
  {
    ...
    content: (
      <div className="p-4">
        ...
        <p className="text-gray-600 text-sm leading-relaxed">
          We're verifying your email address. This helps secure your account and enables important notifications.
        </p>
      </div>
    ),
    position: 'bottom',
  ...
  {
    selector: '.verification-icon',
    content: (
      <div className="p-4">
        <h3 className="text-lg font-semibold text-gray-900 mb-2">Verification Status</h3>
        <p className="text-gray-600 text-sm leading-relaxed">
          The icon shows the current status - loading for verification in progress, checkmark for success, or X for failure.
        </p>
      </div>
    ),
    position: 'bottom',
  ...
  {
    selector: '.verification-actions',
    content: (
      <div className="p-4">
        <h3 className="text-lg font-semibold text-gray-900 mb-2">Next Steps</h3>
        <p className="text-gray-600 text-sm leading-relaxed">
          If verification fails, you can request a new verification email or contact support for assistance.
        </p>
      </div>
    ),
    position: 'top',
...
interface EmailVerificationTutorialProps {
  children: React.ReactNode
}

export function EmailVerificationTutorial({ children }: EmailVerificationTutorialProps) {
  return (
    <TourProvider
