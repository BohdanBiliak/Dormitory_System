  ...
  getMyPayments: () =>
    applyDecorators(
      ApiOperation({
        ...
        description:
          "Retrieves paginated list of payments for the authenticated user, including payment history, current dues, and status information.",
      }),
      ApiQuery({
        name: "limit",
        type: Number,
  ...
  getMyStats: () =>
    applyDecorators(
      ApiOperation({
        ...
        description:
          "Returns comprehensive payment statistics for the authenticated user including payment history, average amounts, and trends.",
      }),
      ApiOkResponse({
  ...
  uploadPaymentProof: () =>
    applyDecorators(
      ApiOperation({
        ...
        description:
          "Uploads payment proof document (receipt, bank transfer confirmation, etc.) for a specific payment. Supports PDF, JPG, PNG formats up to 10MB.",
      }),
      ...
      ApiOkResponse({
        ...
        schema: {
          ...
          properties: {
            ...
            fileName: {
              type: "string",
              example: "payment_receipt_october.pdf",
            },
            fileSize: { type: "number", example: 2048576 },
            uploadedAt: {
              type: "string",
              format: "date-time",
              example: "2025-10-03T11:30:00.000Z",
            },
            status: { type: "string", example: "AWAITING_CONFIRMATION" },
            message: {
              type: "string",
              example:
                "Payment proof uploaded successfully. Awaiting admin confirmation.",
            },
          },
        },
      }),
      ...
      ApiForbiddenResponse({
        description: "Authentication required or payment not owned by user",
      }),
    ),
  ...
  createPayment: () =>
    applyDecorators(
      ApiOperation({
        ...
        description:
          "Creates a new payment record for a user. Only admins can create payments. Automatically sends notification to the user.",
      }),
      ApiBody({
  ...
  getPendingPayments: () =>
    applyDecorators(
      ApiOperation({
        ...
        description:
          "Retrieves all pending payments, optionally filtered by dormitory. Shows payments that are due but not yet paid.",
      }),
      ApiQuery({
        name: "dormitoryId",
        type: String,
  ...
  getAwaitingConfirmation: () =>
    applyDecorators(
      ApiOperation({
        ...
        description:
          "Retrieves payments that have proof uploaded but are awaiting admin confirmation. Helps admins review and approve payments.",
      }),
      ApiQuery({
        name: "dormitoryId",
        type: String,
            ...
            summary: {
              ...
              properties: {
                ...
                oldestSubmission: {
                  type: "string",
                  format: "date-time",
                  example: "2025-09-30T14:20:00.000Z",
                },
              },
            },
          },
  ...
  confirmPayment: () =>
    applyDecorators(
      ApiOperation({
        ...
        description:
          "Confirms a payment after reviewing the uploaded proof. Marks payment as paid and sends confirmation notification to user.",
      }),
      ApiParam({
        name: "id",
        type: String,
        ...
        schema: {
          ...
          properties: {
            ...
            confirmedBy: {
              type: "string",
              format: "uuid",
              example: "admin-456e7890-e89b-12d3-a456-426614174001",
            },
            confirmedAt: {
              type: "string",
              format: "date-time",
            ...
            message: {
              type: "string",
              example:
                "Payment confirmed successfully. User has been notified.",
            },
          },
        },
      }),
      ...
      ApiBadRequestResponse({
        description:
          "Payment cannot be confirmed (already confirmed or invalid status)",
      }),
      ApiForbiddenResponse({ description: "Admin access required" }),
    ),
  ...
  rejectPayment: () =>
    applyDecorators(
      ApiOperation({
        ...
        description:
          "Rejects a payment proof and provides feedback to user. User can resubmit proof after addressing the issues.",
      }),
      ApiParam({
        name: "id",
        type: String,
        ...
        schema: {
          ...
          properties: {
            ...
            rejectedAt: {
              type: "string",
              format: "date-time",
              example: "2025-10-03T12:45:00.000Z",
            },
            rejectionReason: {
              type: "string",
            ...
            message: {
              type: "string",
              example:
                "Payment rejected. User has been notified and can resubmit proof.",
            },
          },
        },
      }),
      ApiNotFoundResponse({ description: "Payment not found" }),
      ApiBadRequestResponse({
        description: "Payment cannot be rejected (invalid status)",
      }),
      ApiForbiddenResponse({ description: "Admin access required" }),
    ),
  ...
  getOverduePayments: () =>
    applyDecorators(
      ApiOperation({
        ...
        description:
          "Retrieves all payments that are past their due date. Helps admins identify users who need payment reminders or follow-up actions.",
      }),
      ApiOkResponse({
  ...
  getStats: () =>
    applyDecorators(
      ApiOperation({
        ...
        description:
          "Returns comprehensive payment statistics for admin dashboard. Can be filtered by dormitory for dormitory-specific insights.",
      }),
      ApiQuery({
        name: "dormitoryId",
        type: String,
  ...
  getPaymentById: () =>
    applyDecorators(
      ApiOperation({
        ...
        description:
          "Retrieves detailed information about a specific payment. Users can only access their own payments, admins can access any payment.",
      }),
      ApiParam({
        name: "id",
        type: String,
            ...
            adminActions: {
              ...
              items: {
                ...
                properties: {
                  ...
                  notes: {
                    type: "string",
                    example: "Payment confirmed after receipt verification",
                  },
                },
              },
            },
  ...
  getPayments: () =>
    applyDecorators(
      ApiOperation({
        ...
        description:
          "Retrieves payments with advanced filtering options. Admins can filter across all users, regular users only see their own payments.",
      }),
      ApiOkResponse({
