...
async updateRecurringPayment(id: string, data: Prisma.RecurringPaymentUpdateInput) {
  return this.prisma.recurringPayment.update({
    ...
    async updatePaymentProof(id: string, proofUrl: string, filename: string): Promise<Payment> {
        return this.prisma.payment.update({
            where: { id },
            data: {
    ...
    async confirmPayment(id: string, confirmedBy: string, managerNotes?: string): Promise<Payment> {
        return this.prisma.payment.update({
            where: { id },
            data: {
    ...
    async rejectPayment(id: string, rejectedBy: string, rejectionReason: string): Promise<Payment> {
        return this.prisma.payment.update({
            where: { id },
            data: {
    ...
    async getPaymentStats(userId?: string, dormitoryId?: string): Promise<{
        total: number;
        paid: number;
        pending: number;
        overdue: number;
