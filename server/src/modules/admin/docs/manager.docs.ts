...
export const ManagerDocs = {
  ...
  createManager: () =>
    applyDecorators(
      ApiOperation({ 
        ...
        description: 'Creates a new dormitory manager account. Only SuperAdmin can create managers.'
      }),
      ApiBody({ 
      ...
      ApiBadRequestResponse({ description: 'Passwords do not match or invalid data' }),
      ApiForbiddenResponse({ description: 'Only SuperAdmin can create managers' })
    ),
  ...
  getManagers: () =>
    applyDecorators(
      ...
      ApiQuery({ name: 'sortBy', required: false, enum: ['Name', 'Email'], example: 'Name', description: 'Sort by field' }),
      ApiQuery({ name: 'show', required: false, enum: ['All', 'Residents only'], example: 'All', description: 'Filter by type' }),
      ApiQuery({ name: 'dormitoryId', required: false, type: String, description: 'Filter by dormitory ID' }),
      ApiOkResponse({ 
  ...
  updateManager: () =>
    applyDecorators(
      ApiOperation({ 
        ...
        description: 'Updates manager profile information. Only SuperAdmin can update managers.'
      }),
      ApiParam({ name: 'id', type: String, description: 'Manager ID (UUID)' }),
      ApiBody({ 
      ...
      ApiForbiddenResponse({ description: 'Only SuperAdmin can update managers' })
    ),
  ...
  deactivateManager: () =>
    applyDecorators(
      ApiOperation({ 
        ...
        description: 'Deactivates a manager account (soft delete). Manager will lose access to the system.'
      }),
      ApiParam({ name: 'id', type: String, description: 'Manager ID (UUID)' }),
      ApiOkResponse({ 
  ...
  activateManager: () =>
    applyDecorators(
      ApiOperation({ 
        ...
        description: 'Reactivates a deactivated manager account. Manager will regain access to the system.'
      }),
      ApiParam({ name: 'id', type: String, description: 'Manager ID (UUID)' }),
      ApiOkResponse({ 
