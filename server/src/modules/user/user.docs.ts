...
export const UserDocs = {
  ...
  findAll: () =>
    applyDecorators(
      ...
      ApiQuery({ name: "email", required: false, description: "Filter users by email", example: "user@example.com" }),
      ApiQuery({ name: "displayName", required: false, description: "Filter users by display name", example: "Bohdan" }),
      ApiQuery({ name: "page", required: false, description: "Page number (default: 1)", example: 2 }),
      ApiQuery({ name: "limit", required: false, description: "Items per page (default: 10)", example: 5 }),
      ApiOkResponse({
