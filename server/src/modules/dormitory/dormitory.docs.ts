...
export const DormitoryDocs = {
  controller: () => applyDecorators(ApiTags("Dormitories"), ApiBearerAuth()),
  ...
  create: () =>
    applyDecorators(
      ApiOperation({
        ...
        description:
          "Creates a new dormitory with floor-by-floor room type assignments and pricing configuration. Supports file uploads for dormitory photos. Room photos are automatically inherited from room types. Admins only.",
      }),
      ApiConsumes("multipart/form-data"),
      ApiBody({
        description:
          "Dormitory creation data with floor assignments and optional dormitory photos",
        schema: {
          type: "object",
          properties: {
            ...
            "floorAssignments[0][roomAssignments][1][roomNumbers]": {
              ...
              example: "[4,5,6,7]",
              description:
                "JSON array of room numbers for double rooms on same floor",
            },
            ...
            photos: {
              ...
              description:
                "Dormitory photos only (max 10 files). Room photos are inherited from room types.",
              maxItems: 10,
            },
          },
          required: [
      ...
      ApiCreatedResponse({
        description:
          "Dormitory successfully created with floors and rooms based on assignments. Room photos are automatically inherited from room types.",
        schema: {
          example: {
            id: "uuid",
            ...
            status: "Active",
            photos: [
              "https://s3.example.com/dormitories/dormitory-photo1.jpg",
              "https://s3.example.com/dormitories/dormitory-photo2.jpg",
            ],
                ...
                rooms: [
                  {
                    ...
                    dormitoryId: "uuid",
                    photos: [
                      "https://s3.example.com/room-types/SGL/photo1.jpg",
                      "https://s3.example.com/room-types/SGL/photo2.jpg",
                    ],
                  ...
                  },
                  {
                    ...
                    dormitoryId: "uuid",
                    photos: [
                      "https://s3.example.com/room-types/DBL/photo1.jpg",
                      "https://s3.example.com/room-types/DBL/photo2.jpg",
                    ],
                    roomEquipment: [
                      "Bed",
                      "Bed",
                ...
                rooms: [
                  {
                    ...
                    dormitoryId: "uuid",
                    photos: [
                      "https://s3.example.com/room-types/TPL/photo1.jpg",
                    ],
                    roomEquipment: [
                      "Bed",
                      "Bed",
      ...
      ApiBadRequestResponse({
        description:
          "Invalid dormitory data, floor assignments, room type references, or file upload errors",
        schema: {
          example: {
            statusCode: 400,
            message: [
      ...
      ApiForbiddenResponse({
        description: "Only admins can create dormitories",
      }),
      ApiConflictResponse({
  ...
  findAll: () =>
    applyDecorators(
      ApiOperation({
        ...
        description:
          "Returns list of all active dormitories with floor and room counts. No authentication required.",
      }),
      ApiOkResponse({
  ...
  findDeactivated: () =>
    applyDecorators(
      ApiOperation({
        ...
        description:
          "Returns list of deactivated dormitories. Admin access required.",
      }),
      ApiOkResponse({
  ...
  findOne: () =>
    applyDecorators(
      ApiOperation({
        ...
        description:
          "Returns detailed information about a specific dormitory including floors, rooms with their types and statistics",
      }),
  ...
  update: () =>
    applyDecorators(
      ApiOperation({
        ...
        description:
          "Updates dormitory details. Only admins can update dormitories.",
      }),
      ApiParam({ name: "id", description: "Dormitory UUID" }),
      ApiBody({
      ...
      ApiForbiddenResponse({
        description: "Only admins can update dormitories",
      }),
    ),
  ...
  activate: () =>
    applyDecorators(
      ApiOperation({
        ...
        description:
          "Reactivates a deactivated dormitory, making it available for new residents",
      }),
      ApiParam({ name: "id", description: "Dormitory UUID" }),
      ApiOkResponse({
  ...
  deactivate: () =>
    applyDecorators(
      ApiOperation({
        ...
        description:
          "Deactivates a dormitory if no active residents remain. Prevents new bookings.",
      }),
      ApiParam({ name: "id", description: "Dormitory UUID" }),
      ApiOkResponse({
      ...
      ApiBadRequestResponse({
        ...
        schema: {
          example: {
            statusCode: 400,
            message:
              "Cannot deactivate dormitory with 15 active residents. Please relocate residents first.",
            error: "Bad Request",
            activeResidents: 15,
          },
        },
      ...
      ApiForbiddenResponse({
        description: "Only admins can deactivate dormitories",
      }),
    ),
};
