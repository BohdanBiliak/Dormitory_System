...
import { IsString, IsInt, IsArray, IsOptional, Min, Max, IsNumber, IsEnum } from 'class-validator';
...
export class UpdateRoomTypeDto {
  ...
  @ApiPropertyOptional({ example: 28.0, description: 'Room area in square meters' })
  @IsOptional()
  @IsNumber()
  @Min(0)
  area?: number;
