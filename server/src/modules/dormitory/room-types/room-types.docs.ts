  ...
  create: () =>
    applyDecorators(
      ApiOperation({
        ...
        description: 'Creates a new room type with photos. Photos are required and will be inherited by all rooms of this type when creating dormitories. Admin access required.'
      }),
        ...
        schema: {
          ...
          properties: {
            ...
            photos: {
              ...
              description: 'Room type photos (required, max 10 files). These photos will be inherited by all rooms of this type.',
              maxItems: 10
            }
          },
          required: ['name', 'typeCode', 'capacity', 'category', 'equipment', 'photos']
        }
      }),
      ApiCreatedResponse({
  ...
  findAll: () =>
    applyDecorators(
      ApiOperation({
        ...
        description: 'Returns list of all room types with their photos and equipment. Admin access required.'
      }),
      ApiOkResponse({
        ...
        schema: {
          ...
          items: {
            ...
            properties: {
              ...
              description: { type: 'string', example: 'A standard room with 2 beds' },
              capacity: { type: 'number', example: 2 },
              area: { type: 'number', example: 25.5 },
              category: { type: 'string', example: 'RESIDENTIAL' },
              equipment: { type: 'array', items: { type: 'string' }, example: ['bed', 'desk'] },
              photos: {
                type: 'array',
                items: { type: 'string' },
                example: ['https://s3.example.com/room-types/STD-DBL/photo1.jpg']
              },
  ...
  findOne: () =>
    applyDecorators(
      ApiOperation({
        ...
        description: 'Returns detailed information about a specific room type including usage statistics'
      }),
      ApiParam({ name: 'id', description: 'Room type ID (CUID)', example: 'cmgjauk7z0000qy01d5g4j8jp' }),
      ApiOkResponse({
  ...
  update: () =>
    applyDecorators(
      ApiOperation({
        ...
        description: 'Updates room type information. Changes to equipment and photos will affect all existing rooms of this type.'
      }),
      ApiConsumes('multipart/form-data'),
      ...
      ApiOkResponse({
        ...
        schema: {
          example: {
            ...
            photos: ["https://s3.example.com/room-types/STD-DBL/new-photo1.jpg"],
  ...
  delete: () =>
    applyDecorators(
      ApiOperation({
        ...
        description: 'Deletes a room type if it is not currently used by any rooms. This action cannot be undone.'
      }),
      ApiParam({ name: 'id', description: 'Room type ID (CUID)' }),
      ApiOkResponse({
      ...
      ApiBadRequestResponse({
        ...
        schema: {
          example: {
            statusCode: 400,
            message: "Room type 'Standard Double Room' is currently used by 45 rooms and cannot be deleted",
            error: "Bad Request",
            usageDetails: {
              totalRooms: 45,
