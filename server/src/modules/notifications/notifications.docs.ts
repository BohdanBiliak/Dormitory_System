  ...
  getNotifications: () =>
    applyDecorators(
      ApiOperation({
        ...
        description: "Retrieves notifications for the authenticated user with optional filtering by type, read status, date range, and priority. Returns paginated results sorted by creation date (newest first)."
      }),
      ApiQuery({
        name: "type",
            ...
            data: {
              ...
              items: {
                ...
                properties: {
                  ...
                  title: { type: "string", example: "Room Booking Request Approved" },
                  message: { type: "string", example: "Your booking request for room 301 has been approved." },
                  priority: { 
                    type: "string", 
                  ...
                  data: {
                    type: "object",
                    description: "Additional notification data (varies by type)",
                    example: {
                  ...
                  createdAt: { type: "string", format: "date-time", example: "2025-10-03T10:30:00.000Z" },
                  readAt: { 
                    type: "string", 
                    format: "date-time", 
                    nullable: true,
      ...
      ApiBadRequestResponse({ 
        ...
        schema: {
          example: {
            statusCode: 400,
            message: ["Invalid date format for startDate", "isRead must be a boolean value"],
            error: "Bad Request"
          }
        }
      })
  ...
  getUnreadCount: () =>
    applyDecorators(
      ApiOperation({
        ...
        description: "Returns the total number of unread notifications for the authenticated user. Useful for displaying notification badges in the UI."
      }),
      ApiOkResponse({
  ...
  getNotificationStats: () =>
    applyDecorators(
      ApiOperation({
        ...
        description: "Returns comprehensive statistics about user's notifications including counts by type, priority, and read status. Useful for analytics and dashboard displays."
      }),
      ApiOkResponse({
        ...
        schema: {
          type: "object",
          properties: {
            total: { type: "number", example: 150, description: "Total notifications received" },
            unread: { type: "number", example: 12, description: "Total unread notifications" },
            read: { type: "number", example: 138, description: "Total read notifications" },
            byType: {
              type: "object",
  ...
  markAsRead: () =>
    applyDecorators(
      ApiOperation({
        ...
        description: "Marks a specific notification as read for the authenticated user. Updates the readAt timestamp and decreases the unread count."
      }),
      ApiParam({
        name: "id",
        type: String,
  ...
  createAnnouncement: () =>
    applyDecorators(
      ApiOperation({
        ...
        description: "Creates announcement notifications for specified users. Only admins can send announcements. Supports targeting multiple users simultaneously."
      }),
      ApiBody({
        schema: {
          type: "object",
          properties: {
            ...
            message: { 
              type: "string", 
              example: "Dear residents, the dormitory will undergo scheduled maintenance on October 15th from 9 AM to 5 PM. Water and electricity may be temporarily unavailable.",
        ...
        examples: {
          dormitoryMaintenance: {
            ...
            value: {
              ...
              message: "Water and electricity will be temporarily unavailable during maintenance work.",
          ...
          emergencyNotice: {
            ...
            value: {
              ...
              message: "Emergency evacuation drill will be conducted today at 3 PM. Please follow safety protocols.",
              targetUserIds: [
                "123e4567-e89b-12d3-a456-426614174000",
                "456e7890-e89b-12d3-a456-426614174001"
              ]
      ...
      ApiCreatedResponse({
        ...
        schema: {
          type: "object",
          properties: {
            message: { type: "string", example: "Announcement sent successfully" },
            notificationsCreated: { type: "number", example: 25 },
            targetUsers: { type: "number", example: 25 },
            failedDeliveries: { type: "number", example: 0 },
            announcementId: { type: "string", format: "uuid", example: "789e0123-e89b-12d3-a456-426614174002" },
            createdAt: { type: "string", format: "date-time", example: "2025-10-03T11:00:00.000Z" },
            summary: {
              type: "object",
              properties: {
                title: { type: "string", example: "Scheduled Maintenance - October 15th" },
  ...
  createTestNotification: () =>
    applyDecorators(
      ApiOperation({
        ...
        description: "Creates a test notification for the authenticated user. Useful for testing notification delivery and UI display. Only available in development/testing environments."
      }),
      ApiCreatedResponse({
        ...
        schema: {
          type: "object",
          properties: {
            id: { type: "string", format: "uuid", example: "test-123e4567-e89b-12d3-a456-426614174000" },
            type: { type: "string", example: "ROOM_BOOKING_REQUEST" },
            title: { type: "string", example: "Test Notification" },
            message: { type: "string", example: "This is a test notification to verify the system works" },
            priority: { type: "string", example: "NORMAL" },
            isRead: { type: "boolean", example: false },
            createdAt: { type: "string", format: "date-time", example: "2025-10-03T11:15:00.000Z" },
            testMetadata: {
              type: "object",
              properties: {
                ...
                expiresAt: { type: "string", format: "date-time", example: "2025-10-03T12:15:00.000Z" }
              }
            }
          }
        }
      ...
      ApiBadRequestResponse({ 
        ...
        schema: {
          example: {
            statusCode: 400,
            message: "Test notifications are not available in production environment",
            error: "Bad Request"
          }
        }
      })
